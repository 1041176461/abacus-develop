                ...
                for (const auto& co5: co4.second)
                {
                    ...
                    for (const auto& co6: co5.second)
                    {
                        ...
                        for (size_t MB = 0; MB != 2 * LB + 1; ++MB)
                        {
                            ...
                            overlap[0] = -1 * factor
                                         * co6.second.cal_overlap(tauA * GlobalC::ucell.lat0, tauB * GlobalC::ucell.lat0,
                                                                  MA,
                                                                  1,
                                                                  MB); // m =  1
                            ...
                            overlap[2] = factor * co6.second.cal_overlap(tauA * GlobalC::ucell.lat0, tauB * GlobalC::ucell.lat0, MA, 0,
                                                                         MB); // m =  0
