                                 ...
                                 const bool& init_Vr)
{
    ...
    if (init_Vr)
        this->m_abfs_r_abfs.init(3, orb, kmesh_times, lcaos_rmax + abfs_ccp_rmax, Lmax_vr) int Lmax
            = std::max(Lmax_v, Lmax_c, Lmax_vr);
    ...
    if (init_Vr)
    {
        this->m_abfs_r_abfs.init_radial(this->abfs_ccp, this->abfs, MGT) this->m_abfs_r_abfs.init_radial_table();
    }
